  ...
  <div class="pt-6">
    ...
    <div class="mx-auto mt-6 max-w-2xl sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:gap-x-8 lg:px-8">
      <div class="aspect-h-4 aspect-w-3 hidden overflow-hidden rounded-lg lg:block">
        <img
          src="https://s3.amazonaws.com/prod-wp-tunota/wp-content/uploads/2024/11/principal-chill-guy-meme-png-para-usar-de-perfil-y-compartir-2024-11-21_seo_ba.jpg"
    ...
    <p class="text-3xl tracking-tight text-gray-900">{{ proizvod.naziv }}€</p>
...
onMounted(async () => {
  try {
    const response = await axios.get('http://localhost:5173/proizvodi/1');
